            ...
            <div className="max-w-5xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <Card className="p-8 rounded-3xl bg-green-50/40 border-2 border-green-100 hover:border-green-200 transition-all duration-300">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    La création de la CPTS Ouest Gironde répond à un besoin des
                    professionnels de santé de mieux se connaître, de mieux
                    travailler ensemble et de construire collectivement les
                    réponses adaptées aux défis qui les attendent.
                  </p>
                </Card>
                ...
                <Card className="p-8 rounded-3xl bg-teal-50/40 border-2 border-teal-100 hover:border-teal-200 transition-all duration-300">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    fluidifier les prises en charge et de rendre leur territoire
                    attractif, ont créé cette dynamique.
                  </p>
                </Card>
              </div>
              ...
              <div className="mt-8 p-8 rounded-3xl bg-green-50/30 border-2 border-green-100">
                <p className="text-muted-foreground leading-relaxed text-lg">
                  La CPTS a signé un contrat avec l'Agence Régionale de Santé et
                  la caisse d'Assurance Maladie de la Gironde le{" "}
                  <strong className="text-foreground">15 juin 2022</strong> dans
                  le cadre de l'Accord Conventionnel Interprofessionnel (ACI) du
                  21 août 2019.
                </p>
              </div>
            </div>
          ...
          <div className="container mx-auto px-4 lg:px-8">
            <div className="max-w-5xl mx-auto">
              ...
              <p className="text-xl text-muted-foreground text-center mb-12 text-balance">
                Le projet de santé de la CPTS Ouest-Gironde s'articule autour de
                4 missions socles
              </p>
                    ...
                    <div className="flex-1">
                      ...
                      <ul className="space-y-3 text-muted-foreground">
                        ...
                        <li className="flex items-start gap-2">
                          <span className="text-primary mt-1">•</span>
                          <span>
                            Amélioration de la prise en charge de l'insuffisance
                            cardiaque
                          </span>
                        </li>
                        <li className="flex items-start gap-2">
                    ...
                    <div className="flex-1">
                      ...
                      <ul className="space-y-3 text-muted-foreground">
                        <li className="flex items-start gap-2">
                          <span className="text-primary mt-1">•</span>
                          <span>
                            Sensibiliser la population aux dépistages (cancer du
                            sein, colorectal, col de l'utérus)
                          </span>
                        </li>
                        <li className="flex items-start gap-2">
                          <span className="text-primary mt-1">•</span>
                        ...
                        <li className="flex items-start gap-2">
                          <span className="text-primary mt-1">•</span>
                          <span>
                            Diffusion des dispositifs d'écoute et ressources en
                            planning familial
                          </span>
                        </li>
                        <li className="flex items-start gap-2">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-muted-foreground leading-relaxed">
                        ...
                        optionnelles en faveur du développement de la qualité et
                        de la pertinence des soins et/ou de l'accompagnement des
            ...
            <div className="max-w-5xl mx-auto">
                ...
                <div className="flex flex-col lg:flex-row gap-8 items-center">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-muted-foreground leading-relaxed mb-6">
                      ...
                      comme structure juridique. L'association de la CPTS Ouest
                      Gironde a été constituée en 2021.
                    </p>
              ...
              <Card className="p-8 lg:p-12 rounded-3xl bg-primary/5 border-2 border-primary/20">
                ...
                <p className="text-muted-foreground leading-relaxed mb-8 text-center">
                  L'instance décisionnelle est le conseil d'administration de la
                  CPTS composé de 8 professionnels de santé suivants :
                </p>
              ...
              <Card className="mt-8 p-8 rounded-3xl bg-card border-2">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  mission socle et mission optionnelle afin de suivre et mettre
                  en œuvre le projet de santé. Leur nombre n'est pas limité et
                  pourra intégrer tout professionnel de santé qui souhaite
                  s'impliquer dans la dynamique territoriale.
                </p>
              </Card>
            </div>
          </div>
